...
elseif (isset($_POST['login']))
{
    ...
    $username =  $user;
    $password =  $_POST['pass'];
    $password1 =  $_POST['pass_ag'];
    $email = mysqli_real_escape_string($con, $_POST['email']);
    $ph = $_POST['ph'];

   // if($password && $password1 && $password1==$password)
   // {
    $query ="INSERT INTO users(username, password, name,email,ph,status) VALUES ('$username','$password','$user','$email','$ph','NO')";
       if($conn->query($query)==TRUE)
        ...
        $conn->close();
  //  }else
  //      echo "<script> alert('pass worddo not match'); </script>  " ;
...
<html>
<head>
    <title>The Signup form File feilder</title>
...
<div class="main">
    ...
    <form  action="#" method="post">
        <div class="lable">
            <div class="col_1_of_2 span_1_of_2"><input type="text" required name="FirstName" class="text"   placeholder=  'First Name'></div>
            <div class="col_1_of_2 span_1_of_2"><input type="text"  required name="LastName"  class="text"   placeholder=  'Last Name'></div>

        </div>
        <div class="lable-2">
            <input type="text" name="email" required class="text"  placeholder="your@email.com "  >
            <h3>password</h3>
            <input type="password" name="pass" required class="text" placeholder= 'Password ' >
            <h3>re enter password</h3>
            <input type="password" name="pass_ag" required  class="text"  placeholder= 'Password '>
            <h3>Phone No. </h3>
            <input type="number" name="ph" required class="text"  placeholder= 'Phone No. '">


        </div>
        <h3>By creating an account, you agree to our <span class="term"><a href="#">Terms & Conditions</a></span></h3>
        <div class="submit">
            <input type="submit" name="login" onclick="myFunction()" value="Create account" >
        </div>
        <div class="clear"> </div>
    </form>
</div>
<div class="copy-right">
    <p> &copy;  Signup_form. All rights reserved | Template by <a href="http://google.com/"> akshay  </a></p>
